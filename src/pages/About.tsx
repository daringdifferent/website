            ...
            {[
              {
                ...
                description: "Author of books,sharing insights and experiences on disability awareness and inclusive practices.",
                color: "#FF9E1B",
                gradient: "linear-gradient(135deg, #FF9E1B 0%, #FFBE5C 100%)",
                features: ["1 Published Book", "International Distribution"]
              },
              {
                ...
                features: ["10+ Episodes", "Global Audience"]
              },
              {
