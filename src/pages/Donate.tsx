...
// Base Stripe URL - this is your payment link without any parameters
const STRIPE_BASE_URL = 'https://buy.stripe.com/fZe6so3VVgNp7sI3cd';
...
const Donate = () => {
  ...
  const handleDonate = () => {
    ...
    let paymentUrl = STRIPE_BASE_URL;

    // Add mode parameter based on donation frequency
    if (donationFrequency === 'monthly') {
      paymentUrl += '?frequency=recurring';
    }
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            ...
            >
                ...
                <div className="grid grid-cols-2 gap-4">
                  {[
                    ...
                    <motion.button
                      ...
                      className={`px-4 py-3 rounded-xl border text-center transition-all ${donationFrequency === option.id
              ...
              <div className="mb-8 text-center text-[#0A2240]/70">
                <p>You'll be able to choose your donation amount on the next screen.</p>
              </div>
              ...
              <div className="mb-6">
                ...
                >
                  ...
                  >
                    ...
                    <span>{isProcessing ? 'Processing...' : 'Continue to Donate'}</span>
                  </motion.button>
                </motion.div>
              </div>
