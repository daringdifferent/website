            ...
            comments.map((comment, index) => (
              ...
              >
                <div className="flex items-start gap-3">
                  <div className="w-8 h-8 rounded-full bg-gradient-to-br from-[#FF9E1B] to-[#00B2A9] flex items-center justify-center flex-shrink-0">
                    <User className="w-4 h-4 text-white" />
                  </div>
                  <div className="flex-grow">
                    <div className="flex items-center justify-between mb-1">
                      <p className="font-medium text-white">{comment.user_id}</p>
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center gap-4">
                        ...
                        <div className="p-4 sm:p-0 flex-grow">
                          <h4 className={`font-bold text-lg mb-1 line-clamp-1 ${
                            episode.id === activeEpisode.id ? 'text-[#FF9E1B]' : 'text-white'
                          }`}>
                            {episode.title}
                          </h4>
