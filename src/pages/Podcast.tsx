              ...
              <div className="flex p-1 bg-white/80 backdrop-blur-sm rounded-full shadow-sm border border-gray-100">
                {[
                  ...
                  <motion.button
                    ...
                    className={`px-4 py-2 rounded-full text-sm font-medium transition-all ${currentFilter === filter.id
              ...
              >
                ...
                <div className="relative aspect-video overflow-hidden">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center z-20 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    <motion.button
                      ...
                      whileHover={{ scale: 1.1 }}
                      whileTap={{ scale: 0.95 }}
                      className={`w-12 h-12 rounded-full flex items-center justify-center shadow-lg ${episode.is_premium
                ...
                <div className="px-6 pb-6 pt-2">
                  <motion.button
                    ...
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
                    className={`w-full py-2.5 rounded-full flex items-center justify-center gap-2 transition-all ${episode.is_premium
