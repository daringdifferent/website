...
const Navbar = () => {
  ...
  return (
    <nav className="relative z-50">
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center justify-between h-16 md:hidden">
            ...
            {/* HAMBURGER MENU RIGHT - Fixed onClick handler */}
            <motion.button
              onClick={toggleMenu}
              className="text-white hover:text-[#FF9E1B] transition-colors duration-200 p-2 rounded-full bg-white/10 backdrop-blur-sm z-50"
      ...
      {/* MOBILE MENU OVERLAY - Fixed implementation */}
      <AnimatePresence>
        {isOpen && (
          <motion.div
            key="mobile-menu"
